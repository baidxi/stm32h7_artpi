...
#define GPIO_CFG_SPEED_LOW     (0x00000000 << GPIO_CFG_SPEED_SHIFT)
#define GPIO_CFG_SPEED_MEDIUM  (0x00000001 << GPIO_CFG_SPEED_SHIFT)
#define GPIO_CFG_SPEED_HIGH    (0x00000002 << GPIO_CFG_SPEED_SHIFT)
#define GPIO_CFG_SPEED_MASK    0x00000003


#define GPIO_CFG_PULL_SHIFT    2
#define GPIO_CFG_PULL_NONE     (0x00000000 << GPIO_CFG_PULL_SHIFT)
#define GPIO_CFG_PULL_UP       (0x00000001 << GPIO_CFG_PULL_SHIFT)
#define GPIO_CFG_PULL_DOWN     (0x00000002 << GPIO_CFG_PULL_SHIFT)
#define GPIO_CFG_PULL_MASK     0x00000003


#define GPIO_CFG_DRIVE_SHIFT       4
#define GPIO_CFG_DRIVE_PUSH_PULL   (0x00000000 << GPIO_CFG_DRIVE_SHIFT)
#define GPIO_CFG_DRIVE_OPEN_DRAIN  (0x00000001 << GPIO_CFG_DRIVE_SHIFT)
#define GPIO_CFG_DRIVE_OPEN_SOURCE (0x00000002 << GPIO_CFG_DRIVE_SHIFT)
#define GPIO_CFG_DRIVE_MASK        0x00000003

#define GPIO_CFG_MODE_SHIFT     6
#define GPIO_CFG_MODE_INPUT       (0x0 << GPIO_CFG_MODE_SHIFT)
#define GPIO_CFG_MODE_OUTPUT      (0x1 << GPIO_CFG_MODE_SHIFT)
#define GPIO_CFG_MODE_AF          (0x2 << GPIO_CFG_MODE_SHIFT)
#define GPIO_CFG_MODE_MASK          0x3
